...
export default function DailyTrack({ scope, visible }: { scope: string; visible: boolean }) {
  ...
  return <section className="daily-track content" aria-labelledby="daily-track-title">
